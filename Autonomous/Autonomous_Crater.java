...
public class Autonomous_Crater extends LinearOpMode {
    ...
    private double powerForward[] = {0.2, 0.2};
    private double powerTurnLeft[] = {-0.2, 0.2};
    private double powerTurnRight[] = {0.2, -0.2};
    ...
    private double toArea = (4.3 * ratio);
    private double toCrater = (7.3 * ratio);
    private double firstRun = (2.5 * ratio);
    private double secondRun = (3.4 * ratio);
    ...
    public void leftTurn(double distanceInRotations) {
        ...
        leftFrontMotor.setTargetPosition(leftFrontMotor.getCurrentPosition() - (partsRotationsLeft * 2));
        leftBackMotor.setTargetPosition(leftBackMotor.getCurrentPosition() - (partsRotationsLeft * 2));
        rightFrontMotor.setTargetPosition(rightFrontMotor.getCurrentPosition() + (partsRotationsRight * 2));
        rightBackMotor.setTargetPosition(rightBackMotor.getCurrentPosition() + (partsRotationsRight * 2));
