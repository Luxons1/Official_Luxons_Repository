...
/**
 *
 * This program provides driver station control of the  Mecanum Drive Prototype.
 *
 * This robot uses four VEX Mecanum wheels, each direct driven by
...
@Disabled
public class McnumWheelsTest extends LinearOpMode {
...
//            X2 = gamepad1.left_stick_x * joyScale;
            ...
            Y1 = -0.5 * joyScale; // invert so up is positive
            X1 = 0.5 * joyScale;
            Y2 = -0.5 * joyScale; // Y2 is not used at present
            X2 = 0.5 * joyScale;
